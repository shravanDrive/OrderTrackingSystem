...
{
    public partial class ATCPViewStudent : System.Web.UI.Page
    {
        public enum MessageType { Success, Error, Info, Warning };
        public static string UIN { get; set; } = null;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    UINTextBox.Text = UIN;
                    //string message = Request.QueryString["MessageType"];
                    ...
                    //{
                    //    ShowMessageOperation("Error occured in updation", MessageType.Error);
                    //}
        ...
        protected void EditModeButton_Click(object sender, EventArgs e)
        {
            Response.Redirect("ATCPStudent.aspx?UIN=" + UIN, false);
        }
    }
}
